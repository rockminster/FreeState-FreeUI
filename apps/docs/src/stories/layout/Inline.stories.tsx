...
export const ToolbarComposition: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Example of composing a toolbar interface using nested Inline components.",
      },
    },
  },
};
...
export const TagList: Story = {
  ...
  render: (args) => (
    <Card padding="md">
      <Text weight="medium" size="sm" style={{ marginBottom: "8px", display: "block" }}>
        Project Tags:
      </Text>
      <Inline {...args}>
        ...
        <Badge variant="default" size="sm">Accessibility</Badge>
        <Badge variant="default" size="sm">Storybook</Badge>
        <Badge variant="default" size="sm">Component Library</Badge>
        <Badge variant="default" size="sm">Frontend</Badge>
        <Badge variant="default" size="sm">UI/UX</Badge>
      </Inline>
    </Card>
  ),
  parameters: {
    docs: {
      description: {
        story: "Tag list with wrapping enabled, showing how Inline handles overflow gracefully.",
      },
    },
  },
};
...
export const JustificationOptions: Story = {
    ...
    <div style={{ width: "100%" }}>
      {(["start", "center", "end", "space-between", "space-around", "space-evenly"] as const).map((justify) => (
        <div key={justify} style={{ marginBottom: "24px" }}>
          ...
          <div style={{ border: "1px dashed #ccc", padding: "12px", backgroundColor: "#f9f9f9" }}>
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates different justification options for controlling item distribution.",
      },
    },
  },
};
...
export const MixedContent: Story = {
  ...
  render: (args) => (
    <Card padding="lg">
      ...
      <Inline {...args}>
        ...
        <div style={{ height: "24px", width: "1px", backgroundColor: "#e5e5e5" }} />
        
        <Inline gap="xs" align="center">
          <Text size="sm" color="subdued">Status:</Text>
          <Text size="sm" weight="medium">Deployed</Text>
        </Inline>
  ...
  parameters: {
    docs: {
      description: {
        story: "Complex composition showing mixed content types arranged horizontally with separators.",
      },
    },
  },
};